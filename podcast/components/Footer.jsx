export default function Footer({ blok }) {
  ...
  return (
    <>
      ...
      <div className="flex items-center max-w-7xl mx-auto py-8">
        <img
          src={blok.logo?.filename}
          alt="Footer Logo"
          className="w-8 h-8 mr-5"
        />
        <p className="text-xl text-semibold text-aircall-grey-800">
          {blok.description}
        </p>
      </div>
      <footer className="bg-aircall-grey-100 py-8 text-aircall-grey-900">
        <div className="max-w-7xl mx-auto flex justify-between ">
          ...
          {columns.map((column, idx) => (
            <div key={idx} className="col-span-4 md:col-span-2">
              <h4 className="font-semibold text-left text-aircall-grey-300 text-sm uppercase mb-4">
                {column.title}
              </h4>
              <ul className="text-left text-aircall-grey-300 font-light space-y-2 text-sm">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-aircall-grey-200 mt-16 pt-6 max-w-7xl mx-auto flex flex-col gap-4 md:flex-row items-center font-thin text-sm text-aircall-grey-300">
          ...
          <div className="flex item-center gap-2">
            <div className="w-6 h-6 bg-gray-200 rounded-[8px] flex items-center justify-center">
              <svg
